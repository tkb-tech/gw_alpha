...
ax = plt.subplot(111)
im = ax.imshow(result.reshape((15,15)))
...
sampler = Metropolis(func, 3, proposal_std=2., sample_rate=10)
s = sampler(sample_size=10000)
print 'wwwwwwwwwwwkusadarake'
print "mean\n", np.mean(s, axis=0)
